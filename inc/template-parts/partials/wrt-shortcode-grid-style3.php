...
<div class="wrt-grid">
	<?php foreach($testimonials as $testimonial){ ?>
		<div class="wrt-col-<?php echo $columns_desktop;?> wrt-tabcol-<?php echo $columns_tablet;?> wrt-mobcol-<?php echo $columns_mobile;?>">	
			<div class="item wrt-grid-style3">
				<div class="wrt-body">			
							...
							<div class="wrt-author-contact">
								<?php if ($wrt_setting_options['wrt_grid_hide_company']=='no' && get_post_meta( $testimonial->ID, 'wrt_client_company',true)){ ?>
								  ...
								  <?php } ?>
									...
									<?php if($wrt_setting_options['wrt_grid_hide_company']=='no' && $wrt_setting_options['wrt_grid_hide_website']=='no' && get_post_meta( $testimonial->ID, 'wrt_client_website',true) && get_post_meta( $testimonial->ID, 'wrt_client_company',true)){									
