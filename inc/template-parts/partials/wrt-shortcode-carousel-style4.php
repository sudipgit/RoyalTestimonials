...
<?php foreach($testimonials as $testimonial){?>
	<div class="item wrt-carousel-style4">
		<div class="wrt-body">	
			<div class="wrt-author-title">
				...
				<div class="wrt-author-info">
					...
					<div class="wrt-author-contact">
						  <?php if ($wrt_setting_options['wrt_carousel_hide_company']=='no' && get_post_meta( $testimonial->ID, 'wrt_client_company',true)==true){ ?>
							<p class="wrt_company">
						  ...
						  <?php } ?>
							...
							?>
						   <?php if ($wrt_setting_options['wrt_carousel_hide_website']=='no' && get_post_meta( $testimonial->ID, 'wrt_client_website',true)==true){ ?>
							<p class="wrt_website">
