	...
	*/
...

	{
		...
		$wrt_options=array(
			...
			'wrt_carousel_preview_style'=> sanitize_text_field($_POST['wrt_carousel_preview_style']),

			'wrt_carousel_total' => sanitize_text_field($_POST['wrt_carousel_total']),

			'wrt_carousel_per_slide_desktop' => sanitize_option('', $_POST['wrt_carousel_per_slide_desktop']),

			'wrt_carousel_per_slide_tablet' => sanitize_option('', $_POST['wrt_carousel_per_slide_tablet']),

			'wrt_carousel_per_slide_mobile' => sanitize_option('', $_POST['wrt_carousel_per_slide_mobile']),

			'wrt_carousel_sliding_interval' => sanitize_text_field($_POST['wrt_carousel_sliding_interval']),

			'wrt_carousel_sliding_speed' => sanitize_text_field($_POST['wrt_carousel_sliding_speed']),
			...
			'wrt_grid_preview_style'=> sanitize_text_field($_POST['wrt_grid_preview_style']),

			'wrt_grid_total' => sanitize_text_field($_POST['wrt_grid_total']),

			'wrt_grid_columns_desktop' => sanitize_option('', $_POST['wrt_grid_columns_desktop']),

			'wrt_grid_columns_tablet' => sanitize_option('', $_POST['wrt_grid_columns_tablet']),

			'wrt_grid_columns_mobile' => sanitize_option('', $_POST['wrt_grid_columns_mobile']),
			...
			'wrt_list_preview_style'=> sanitize_text_field($_POST['wrt_list_preview_style']),

			'wrt_list_total' => sanitize_text_field($_POST['wrt_list_total']),
