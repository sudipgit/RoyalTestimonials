...
function wrt_load_royal_testimonials_front_end_css() {
		wp_enqueue_style( 'wrt_testimonials_frontend',
...
function wrt_load_royal_testimonials_front_end_js() {
		...
		wp_enqueue_script( 'wrt_query_js', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js', 'all');
		wp_enqueue_script( 'wrt_carousel_testimonials_js', plugins_url( '/assets/js/wrt-carousel.js', __FILE__ ),'','',true);
